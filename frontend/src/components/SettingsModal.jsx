                            ...
                            >
                                {(() => {
                                    const CATEGORIES = {
                                        ...
                                        "Social": ["search_reddit", "browse_subreddit", "read_reddit_thread", "get_reddit_user", "read_twitch_chat", "ingest_twitch_chat", "search_youtube", "read_youtube_transcript", "ingest_youtube_transcript"],
